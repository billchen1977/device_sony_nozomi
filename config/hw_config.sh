...
dev=/sys/class/leds
echo 1,51,255,39,20,2,84 > $dev/lcd-backlight/als/curve  # ALS curve for group1
echo 1,2,2,0 > $dev/lcd-backlight/als/params  #[gain],[filter_up],[filter_down],[offset]
echo 1 > $dev/lcd-backlight/als/enable  #Sensor on/off. 1 = on, reg 90h

echo 2,21,100,39,20,2,84 > $dev/button-backlight/als/curve  # ALS curve for group2
echo 1,2,2,0 > $dev/button-backlight/als/params  #[gain],[filter_up],[filter_down],[offset]
